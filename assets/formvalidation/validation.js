  ...
  (function() {
    $('#exampleFullForm').formValidation({
      ...
      fields: {
        ...
        //ini untuk form validator supplier
        s_nama: {
          validators: {
            notEmpty: {
              message: 'Masukan Nama Supplier'
            }
          }
        },
        s_alamat: {
          validators: {
            notEmpty: {
              message: 'Masukan Alamat Supplier'
            }
          }
        },
        s_kontak: {
